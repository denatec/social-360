...
export function Header() {
  ...
  return (
    <header className="fixed left-0 top-0 z-50 w-full border-b border-gray-200 bg-white text-black dark:border-zinc-800 dark:bg-[#111] dark:text-white">
      ...
      {/* ================= MENU MOBILE ================= */}
      {menuOpen && (
        <nav className="fixed left-0 top-0 z-50 h-full w-[80%] max-w-sm bg-white px-6 py-6 shadow-2xl dark:bg-[#111] lg:hidden">
          {/* Cabeçalho do menu */}
      ...
      {/* ================= PESQUISA ================= */}
      {searchOpen && (
        <div className="border-t border-gray-200 bg-white p-4 shadow-lg dark:border-zinc-800 dark:bg-[#111]">
          <form
      ...
      {/* ================= ÚLTIMA HORA ================= */}
      <div className="flex h-12 items-center justify-center gap-5 overflow-hidden border-t border-gray-200 bg-gray-50 px-4 dark:border-zinc-800 dark:bg-zinc-900">
